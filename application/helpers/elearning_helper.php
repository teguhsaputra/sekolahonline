...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        ...
        'copyright_setup'   => 'Copyright &copy; 2020 - ' . date('Y') . '<a href="#">Irchas Ramadhan</a>',
        ...
        'site_name_default' => 'Sekolah Online',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Copyright &copy; 2020 - ' . date('Y') . ' ' . get_pengaturan('nama-sekolah', 'value').' by <a href="#">Irchas Ramadhan</a>';
        $return['site_name'] = 'Platform Sekolah Online '.get_pengaturan('nama-sekolah', 'value');
...
function nama_panjang($str_nama) {
    return $str_nama;
}
