...
class Pager
{
    ...
    public function view($array_data, $url, $add_value_segment = array(), $show_info = true)
    {
        ...
        $return = '<div class="row">';
            ...
            $return .= '<nav class="float-right" aria-label="Navigasi">
                <ul class="pagination">';
                ...
                if ($array_data['total_page'] > 1) {
                    ...
                    if (empty($array_data['prev_page'])) {
                        $return .= '<li class="page-item disabled"><a class="page-link" href="#">First</a></li>';
                    } else {
                        $return .= '<li class="page-item"><a class="page-link" href="'.site_url($url.'1'.$add_segment).'">First</a></li>';
                    }
                    ...
                    if ($array_data['total_page'] <= 5) {
                        for ($i = 1; $i <= $array_data['total_page']; $i++) {
                            ...
                            $return .= '<li class="page-item '.$class.'"><a class="page-link" href="'.site_url($url.$i.$add_segment).'">'.$i.'</a></li>';
                        }
                    } else {

                        if ($array_data['current_page'] > 1) {
                            $return .= '<li class="page-item"><a class="page-link" href="'.site_url($url.($array_data['current_page'] - 1).$add_segment).'">Prev</a></li>';
                        } else {
                            $return .= '<li class="page-item disabled"><a class="page-link" href="#">Prev</a></li>';
                        }
                        ...
                        if ($array_data['current_page'] < $array_data['total_page']) {
                            $return .= '<li class="page-item"><a class="page-link" href="'.site_url($url.($array_data['current_page'] + 1).$add_segment).'">Next</a></li>';
                        } else {
                    ...
                    if (empty($array_data['next_page'])) {
                        $return .= '<li class="page-item disabled"><a class="page-link" href="#">Last</a></li>';
                    } else {
                        $return .= '<li class="page-item"><a class="page-link" href="'.site_url($url.$array_data['total_page'].$add_segment).'">Last</a></li>';
                    }
