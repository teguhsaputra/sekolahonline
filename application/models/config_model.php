...
class Config_model extends CI_Model
{
    ...
    public function update_index_default_table()
    {
        ...
        $this->db->query("ALTER TABLE `{$this->db->dbprefix}absen_pengajar` ADD INDEX(`pengajar_id`, `mapel_ajar_id`);");
        $this->db->query("ALTER TABLE `{$this->db->dbprefix}absen_siswa` ADD INDEX(`siswa_id`, `mapel_ajar_id`);");
    ...
    /**
     * Method untuk membuat tabel absen pengajar
     */
    public function create_tb_absen_pengajar()
    {
        $this->db->query("CREATE TABLE `absen_pengajar` (
        `id` int(11) NOT NULL,
        `pengajar_id` int(11) NOT NULL,
        `mapel_ajar_id` int(11) NOT NULL,
        `no_kikd` varchar(100) NOT NULL,
        `pokok_pembahasan` text NOT NULL,
        `status_selesai` int(11) NOT NULL COMMENT '1. selesai\r\n2. belum',
        `ket_absen_siswa` text NOT NULL,
    ...
    /**
     * Method untuk membuat tabel absen siswa
     */
    public function create_tb_absen_siswa()
    {
        $this->db->query("CREATE TABLE `absen_siswa` (
        `id` int(11) NOT NULL,
        `siswa_id` int(11) NOT NULL,
        `mapel_ajar_id` int(11) NOT NULL,
        `status_hadir` int(11) NOT NULL COMMENT '1. Hadir\r\n2. Sakit\r\n3. Izin\r\n4. Alpha',
        `keterangan` text NOT NULL COMMENT 'tulis keterangan selain status hadir',
        `tanggal_buat` datetime NOT NULL,
        `tanggal_update` datetime NOT NULL
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
